...
hi Comment guifg=#05bcc8 guibg=#d5ecd8 ctermfg=242  cterm=none
...
hi IncSearch gui=bold,reverse guifg=#33ff1c guibg=#3454ff ctermfg=82  cterm=bold,reverse
hi LineNr guifg=#af5f00 guibg=#d0d0d0 ctermfg=206  ctermbg=188 cterm=none
hi MatchParen guifg=#342cff guibg=#9aeb95 ctermfg=57  cterm=none
hi ModeMsg gui=bold guifg=#ffff3c guibg=#d5ecd8 ctermfg=227  cterm=bold
hi MoreMsg guifg=yellow ctermfg=226 cterm=none
hi NonText guifg=#8400ff guibg=#d5ecd8 ctermfg=93 cterm=none
hi Normal guifg=#505050 guibg=#d5ecd8 ctermfg=8 cterm=none
hi Pmenu guibg=#ff77ff  cterm=none
hi PmenuSel guibg=grey  cterm=none
hi PmenuSbar guibg=darkgray  cterm=none
hi PmenuThumb gui=reverse  cterm=reverse
hi PreProc guifg=#9b20d1 guibg=#d5ecd8 ctermfg=92  cterm=none
hi Question gui=bold guifg=#006633 guibg=#66ffff ctermfg=23  cterm=bold
hi Search guifg=#3404ff guibg=yellow ctermfg=57  cterm=none
hi SignColumn guifg=cyan guibg=grey ctermfg=51  cterm=none
hi Special guifg=magenta ctermfg=201  cterm=none
hi SpecialKey guifg=#00AEA0 guibg=#8cedd1 ctermfg=37  cterm=none
...
hi Title gui=bold guifg=#006611 guibg=#d5ecd8 ctermfg=22  cterm=bold
hi Todo gui=bold,underline guifg=#ff4c4c guibg=#d8ff33 ctermfg=203  cterm=bold,underline
hi Type gui=bold guifg=orange ctermfg=214  cterm=bold
hi Underlined gui=underline guifg=#0088C5 guibg=#aef0da ctermfg=32  cterm=underline
